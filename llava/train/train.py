...
class TrainingArguments(transformers.TrainingArguments):
    ...
    lora_bias: str = "none"
    ms_cross_attn_lr: Optional[float] = None
...
def safe_save_model_for_hf_trainer(trainer: transformers.Trainer,
                                   output_dir: str, vision_tower_parameters: set):
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        ...
        model.config.ms_cross_attn_lr = training_args.ms_cross_attn_lr
    ...
    if training_args.lora_enable:
        # TODO 只在正常训练的中测试了放开vision encoder的代码，lora也需要测试并修改一下
        ...
        safe_save_model_for_hf_trainer(trainer=trainer,
                                       ...
                                       vision_tower_parameters=vision_tower_parameters)
